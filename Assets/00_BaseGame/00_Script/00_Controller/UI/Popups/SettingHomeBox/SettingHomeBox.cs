...
public class SettingHomeBox : BoxSingleton<SettingHomeBox>
{
    ...
    protected override void Init()
    {
        ...
        btnFps30.onClick.AddListener(delegate { OnFpsButtonClicked(30); });

        btnFps90.onClick.AddListener(delegate { OnFpsButtonClicked(90); });

        btnFps120.onClick.AddListener(delegate { OnFpsButtonClicked(120); });

        btnMail.onClick.AddListener(delegate { Close(); });
        InitLocalization();
    }
